        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#f97316] hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="#" className="hover:text-[#f97316] transition-colors">Chính sách giao hàng</Link></li>
              <li><Link href="#" className="hover:text-[#f97316] transition-colors">Chính sách đổi trả</Link></li>
              <li><Link href="#" className="hover:text-[#f97316] transition-colors">Chính sách bảo mật</Link></li>
              <li><Link href="#" className="hover:text-[#f97316] transition-colors">Điều khoản dịch vụ</Link></li>
              <li><Link href="#" className="hover:text-[#f97316] transition-colors">Hướng dẫn mua hàng</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex flex-col gap-3" suppressHydrationWarning>
              <input 
                ...
                className="px-4 py-2 bg-gray-800 border border-gray-700 rounded focus:outline-none focus:border-[#f97316] text-white text-sm"
                suppressHydrationWarning
              />
              <button 
                type="button"
                className="bg-[#f97316] text-white px-4 py-2 rounded font-medium hover:bg-orange-600 transition-colors text-sm uppercase tracking-wider"
              >
                Đăng ký
              </button>
            </form>
